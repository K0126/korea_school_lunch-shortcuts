...
>
> 5. ios 14 기준으로 설치방법 설명한거라 ios 16에선 ui나 조작 위치 같은게 다를 수도 있음. (이것도 조만간 ios 16에서 스크린샷 찍어서 수정 예정)
> 
> 6. 스크린샷 화질이 좀 구린거 같은데 왜 그런진 나도 모름.

## 버전 안내 
- V.1.0 - 급식 확인 단축어 위젯 개발

- V.1.1 - ios 16 이상의 버전에서 폰트 깨짐 버그 수정
